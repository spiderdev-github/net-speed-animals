...
msgfmt locale/po/fr.po -o locale/fr/LC_MESSAGES/net-speed-animals.mo
echo "✓ Traduction française compilée"

# Compiler la traduction anglaise
msgfmt locale/po/en.po -o locale/en/LC_MESSAGES/net-speed-animals.mo
echo "✓ Traduction anglaise compilée"

# Compiler la traduction allemande
msgfmt locale/po/de.po -o locale/de/LC_MESSAGES/net-speed-animals.mo
echo "✓ Traduction allemande compilée"

# Compiler la traduction espagnol
msgfmt locale/po/es.po -o locale/es/LC_MESSAGES/net-speed-animals.mo
echo "✓ Traduction espagnole compilée"

# Compiler la italienne espagnol
msgfmt locale/po/it.po -o locale/it/LC_MESSAGES/net-speed-animals.mo
